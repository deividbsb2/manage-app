...
var map = {
	...
	"./apps/edit/edit.module": [
		"./src/app/apps/edit/edit.module.ts",
		"common",
		"apps-edit-edit-module"
	],
	"./apps/list/list.module": [
	...
	"./manage/list/list.module": [
		"./src/app/manage/list/list.module.ts",
		"common",
		"manage-list-list-module"
	],
	"./manage/manage/manage.module": [
		"./src/app/manage/manage/manage.module.ts",
		"default~manage-manage-manage-module~person-create-create-module~person-detail-detail-module~person-e~2399f100",
		"common",
		"manage-manage-manage-module"
	],
	"./person/create/create.module": [
	...
	"./person/edit/edit.module": [
		"./src/app/person/edit/edit.module.ts",
		"default~manage-manage-manage-module~person-create-create-module~person-detail-detail-module~person-e~2399f100",
		"common",
		"person-edit-edit-module"
	],
	"./person/list/list.module": [
...
var routes = [
    ...
    { path: 'list-manage', loadChildren: './manage/list/list.module#ListPageModule' },
    { path: 'manage/:id', loadChildren: './manage/manage/manage.module#ManagePageModule' }
];
...
module.exports = __webpack_require__(/*! /home/deivid/projetos/desafio-mba/manage-app/src/main.ts */"./src/main.ts");
