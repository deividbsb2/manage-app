(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["apps-create-create-module"],{

/***/ "./src/app/apps/create/create.module.ts":
/*!**********************************************!*\
  !*** ./src/app/apps/create/create.module.ts ***!
  \**********************************************/
...
/* harmony import */ var _create_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./create.page */ "./src/app/apps/create/create.page.ts");
...
/***/ "./src/app/apps/create/create.page.html":
/*!**********************************************!*\
  !*** ./src/app/apps/create/create.page.html ***!
  \**********************************************/
...
/***/ "./src/app/apps/create/create.page.scss":
/*!**********************************************!*\
  !*** ./src/app/apps/create/create.page.scss ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/app/apps/create/create.page.ts":
/*!********************************************!*\
  !*** ./src/app/apps/create/create.page.ts ***!
  \********************************************/
...
var CreatePage = /** @class */ (function () {
    function CreatePage(appService, loadingController, route, router, formBuilder, toastController) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.appService.post(this.appForm.value)
                                .subscribe(function (res) {
                                var id = res['id'];
                                _this.router.navigate(['/detail-app/' + id]);
                            }, function (err) {
                                console.log(err);
                                _this.presentToast('Erro ao salvar. Tente novamente!');
                            }, function () {
                                _this.presentToast('Aplicativo cadastrado com sucesso!');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    CreatePage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-create',
            template: __webpack_require__(/*! ./create.page.html */ "./src/app/apps/create/create.page.html"),
            styles: [__webpack_require__(/*! ./create.page.scss */ "./src/app/apps/create/create.page.scss")],
        }),
...
//# sourceMappingURL=apps-create-create-module.js.map