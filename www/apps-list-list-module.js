(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["apps-list-list-module"],{

/***/ "./src/app/apps/list/list.module.ts":
/*!******************************************!*\
  !*** ./src/app/apps/list/list.module.ts ***!
  \******************************************/
...
/* harmony import */ var _list_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./list.page */ "./src/app/apps/list/list.page.ts");
...
/***/ "./src/app/apps/list/list.page.html":
/*!******************************************!*\
  !*** ./src/app/apps/list/list.page.html ***!
  \******************************************/
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>\n      Aplicativos\n    </ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-button routerLink=\"/create-app\">\n        <ion-icon name=\"add-circle\" color=\"primary\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item-sliding *ngFor=\"let app of apps\">\n      <ion-item routerLink=\"/detail-app/{{app.id}}\">\n        <ion-icon name=\"appstore\" slot=\"start\" color=\"primary\"></ion-icon>\n        <ion-label>\n          <h2>{{app.name}}</h2>\n          <p>{{app.bundle_id}}</p>\n        </ion-label>\n      </ion-item>\n      <ion-item-options side=\"end\">\n        <ion-item-option color=\"primary\" routerLink=\"/edit-app/{{app.id}}\">\n          Editar\n        </ion-item-option>\n        <ion-item-option color=\"danger\" (click)=\"confirm(app)\">\n          Excluir\n        </ion-item-option>\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n  <ion-list *ngIf=\"!apps\">\n    <ion-item>Não possui aplicativos cadastrados</ion-item>\n  </ion-list>\n</ion-content>"

/***/ }),

/***/ "./src/app/apps/list/list.page.scss":
/*!******************************************!*\
  !*** ./src/app/apps/list/list.page.scss ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./src/app/apps/list/list.page.ts":
/*!****************************************!*\
  !*** ./src/app/apps/list/list.page.ts ***!
  \****************************************/
...
var ListPage = /** @class */ (function () {
    function ListPage(appService, router, loadingController, toastController, alertController) {
    ...
    ListPage.prototype.confirm = function (app) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertController.create({
                            header: 'Atenção!',
                            message: "Deseja realmente excluir <strong>" + app.name + "</strong>?",
    ...
    ListPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-list',
            template: __webpack_require__(/*! ./list.page.html */ "./src/app/apps/list/list.page.html"),
            styles: [__webpack_require__(/*! ./list.page.scss */ "./src/app/apps/list/list.page.scss")],
        }),
...
//# sourceMappingURL=apps-list-list-module.js.map